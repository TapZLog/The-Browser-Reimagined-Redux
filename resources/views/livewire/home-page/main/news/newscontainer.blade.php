<article class="overflow-hidden flex m-3 p-4 border-b-16 border-white h-48 max-md:h-40 shadow-[2px_2px_8px_gray] rounded-sm ">
    <div class="flex-1 flex-wrap ml-auto mr-auto max-lg:m-0 text-left items-center relative">
        <img class="object-scale-down overflow-clip absolute" src=".\assets\testIMG-Landscape.jpg" />
    </div>
